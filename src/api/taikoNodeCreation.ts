...
export const taikoNodeEnvironmentSetup = async (params: { host: string; username: string; password: string; }) => {
    try {
...
export const taikoNodeAndDashboardSetup = async (params: { host: string; username: string; password: string; L1_ENDPOINT_HTTP?: string; L1_ENDPOINT_WS?: string; L1_PROPOSER_PRIVATE_KEY?: string; PROPOSE_BLOCK_TX_GAS_LIMIT?: number; BLOCK_PROPOSAL_FEE?: number; }) => {
    try {
